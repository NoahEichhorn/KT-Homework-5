...
Auch dieser Spinor ist ungültig, weil man(, wie bei dem Fall für Nele Blume,) E^2 = 52212,25;
m^2 = 26732,25; abs(vec(p))^2 = 15180,78 erhält. Damit ist E^2 = m^2 + abs(vec(p))^2 nicht erfüllt.
